...
RUN --mount=type=secret,id=npm_token,env=NODE_AUTH_TOKEN,required=true --mount=type=cache,id=pnpm,target=/pnpm/store pnpm install --frozen-lockfile --store-dir=/pnpm/store
